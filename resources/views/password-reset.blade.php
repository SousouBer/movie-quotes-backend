<div style="width: 100%; padding: 4rem 0; background: linear-gradient(187.16deg, #181623 0.07%, #191725 51.65%, #0D0B14 98.75%);">
    <div style="align-content: center; text-align: center; padding: 2rem 0; margin: 0 auto; width: 50%;">
        ...
        <div style="margin: 2rem 0; text-align: start;">
            ...
            <p style="color: #fff; margin: 2rem 0">You have requested a password reset! In order to change it, Please click the button below to verify your account.</p>
            <a style="background: #E31221; padding: 0.5rem 1.5rem; border-radius: 4px; margin-top: 1rem; color: #fff; text-decoration: none;" href="{{ $resetPasswordUrl }}">Reset Your Password</a>
            <p style="color: #fff; margin: 2rem 0;">If clicking doesn't work, you can try copying and pasting it to your browser:</p>
            <a style="color: #DDCCAA; text-decoration: none;" href="{{ $resetPasswordUrl }}">{{ $resetPasswordUrl }}</a>
